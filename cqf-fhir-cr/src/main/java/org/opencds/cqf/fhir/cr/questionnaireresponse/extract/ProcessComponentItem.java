...
public class ProcessComponentItem {
    ...
    public void processItem(
        ...
        IQuestionnaireResponseItemComponentAdapter answerItem,
        ...
        switch (request.getFhirVersion()) {
            ...
            case R5:
                ...
                if (valueR5 instanceof org.hl7.fhir.r5.model.Coding) {
                    r5componentCodes.setValue(new org.hl7.fhir.r5.model.CodeableConcept().addCoding(
                        (org.hl7.fhir.r5.model.Coding) valueR5));
                } else {
